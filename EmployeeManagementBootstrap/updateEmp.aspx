<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateEmp.aspx.cs" Inherits="EmployeeManagementBootstrap.updateEmp" %>
                        ...
                        <%--<div class="col-md-12">--%>
                            ...
                            <div class="col-md-12  bg-dark">
                                ...
                                <p class="text-center text-white mt-3">
                                    © 2022 WAi Technologies. All rights Reserved
                                    <span><i class="pt-3 social-icon pb-3  text-dark   fab fa-twitter"></i>
                                        <i class="pt-3 social-icon pb-3  text-dark  fab fa-instagram"></i>
                                        <i class="pt-3 social-icon pb-3  text-dark   fab fa-linkedin"></i></span>
